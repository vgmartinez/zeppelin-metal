...
public class Message {
  ...
  public static enum OP {
    ...
    NOTES_SHARED, // para mandar los notebook compartidos
    GET_NOTE_SHARED, // para mandar un notebook especifico
    MOVE_PARAGRAPH_SHARED, // para mover un paragraph en un notebook compartido
    NOTE_UPDATE_SHARED, // para actualizar un notebook compartido
    RUN_PARAGRAPH_SHARED, // ejecutar un parafo en notebook compartido
    CANCEL_PARAGRAPH_SHARED // cancelar la ejecucion de un parafo
  }
